...
export default function ChargerCard() {
    ...
    const FEATURES: Feature[] = [
        { icon: "bolt", label: t('products.chargerCard.features.powerOptions.label', { count: 0 }), value: "60–240 kW" },
        { icon: "plug", label: t('products.chargerCard.features.connectors.label', { count: 0 }), value: "CCS1 / CCS2 / CHAdeMO / GB/T" },
        { icon: "efficiency", label: t('products.chargerCard.features.output.label', { count: 0 }), value: "200–1000 V DC" },
        { icon: "ui", label: t('products.chargerCard.features.efficiency.label', { count: 0 }), value: t('products.chargerCard.features.efficiency.value', { count: 0 }) },
    ];
    return (
        <section
            id="gpd-240"
                        ...
                        <figure className="order-2 lg:order-1 relative overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-black/10">
                            <div className="relative mx-auto aspect-[2/3] max-h-[790px] w-full">
                                <Image
                                    ...
                                    alt={t('products.chargerCard.alt', { count: 0 })}
                                    fill
                        ...
                        <article className="order-1 lg:order-2 flex flex-col rounded-2xl bg-[var(--gp-green)] p-8 sm:p-10 lg:p-12 text-white shadow-xl ring-1 ring-white/10">
                            <header className="max-w-xl">
                                <h2 id="gpd-240-title" className="text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight">
                                    {t('products.chargerCard.title', { count: 0 })}
                                </h2>
                                <p id="gpd-240-desc" className="mt-3 text-white/85">
                                    {t('products.chargerCard.description', { count: 0 })}
                                </p>
                            </header>
                            ...
                            <div className="mt-8 flex flex-wrap gap-3">
                                ...
                                >
                                    {t('products.chargerCard.contactUs', { count: 0 })}
                                </Link>
                            </div>
